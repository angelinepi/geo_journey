...
__author__ = 'angeline.pinilo@gmail.com'
__date__ = '2026-08-15'
__copyright__ = 'Copyright 2026, Angéline Pinilo'
...
class GeoJourneyDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = GeoJourneyDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(GeoJourneyDialogTest)
