...
SOURCES = \
	__init__.py \
	geo_journey.py geo_journey_dialog.py

PLUGINNAME = geo_journey

PY_FILES = \
	__init__.py \
	geo_journey.py geo_journey_dialog.py

UI_FILES = geo_journey_dialog_base.ui
...
QGISDIR=C:\Users\AP\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
